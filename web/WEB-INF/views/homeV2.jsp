        ...
        <div class="page-wrapper">
            ...
            <main class="main clearfix">
            	<div class="grid-container">
                    ...
                    <!-- one-third-boxes -->
                    <div class="row one-third-boxes">
                        <div class="one-third col-4">
                            <div class="img-holder">
                                <img src="/images/v2/landing1.jpg" alt="poker-chips">
                            </div>
                            <div class="info-holder">
                                <a href="/u/singleModeV2"><p>Solo game<span class="pull-right">&rang;</span></p></a>
                            </div>
                        </div>
                        <div class="one-third col-4">
                            <div class="img-holder">
                                <img src="/images/v2/Racing-Poker-Tournament-Play.jpg" alt="poker-table">
                            </div>
                            <div class="info-holder">
                                <a href="/u/gameSelect?mode=tournament"><p>The club<span class="pull-right">&rang;</span></p></a>
                                <p class="subtitle">Tournament Play</p>
                            </div>
                        </div>
                        <div class="one-third col-4">
                            <div class="img-holder">
                                <img src="/images/v2/Racing-Poker-High-Roller.jpg" alt="cards">
                            </div>
                            <div class="info-holder">
                                <a href="/u/gameSelect?mode=pot"><p>High rollers<span class="pull-right">&rang;</span></p></a>
                                <p class="subtitle">Racing Pot Poker&trade;</p>
                            </div>
                        </div>
                    </div>
                    <!-- /one-third-boxes -->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body selected_color" style="color:#ffffff">
                                ...
                                <div id="share-fb" class="row">
                                    <p> 2.Let all your friends know about racing poker and receive 5000 credits. 
...
2) Use the Service for any unauthorized commercial purpose, including but not limited to 
 ...
 (2) gathering or transferring virtual items for sale;  
                                    </p>
                                </div>
                            </div>
                            <div class="modal-footer">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body selected_color" style="color:#ffffff">
                                ...
                                <p> If you have not received an email verification request then please click here to request another one.<span> 
                                    <button type="button" class="btn btn-default" onclick="resendLink()">Resend</button>    </span>
                                </p>
        ...
        <script>
        	$(document).ready(function() {
        		$("body").addClass("landing-v1");
        		
        		var progress = ${ user.levelProgress } * 100.0;
