	...
	<body>
        ...
        <div class="page-wrapper">
            ...
            <main class="main clearfix">
            	<div class="main-inner">
                    <a href="index.html" class="official-logo phablet-hide"></a>
                    <h1>Registration</h1>
                    <div class="form-registration row">
                        <div class="checkbox-holder col-6">
                            <p class="checkbox-holder-title">Please check below requirements in order to register</p>
                            <div class="checkbox clearfix">
                                <input type="checkbox" id="age" onChange="display_register()" value="age_accept">
                                <p>I am over 18/21 years of age whichever is permitted by my country/state law and <br>
                                I am permitted to play games of chance for fun</p>
                            </div>
                            <div class="checkbox clearfix">
                                <input type="checkbox" id="terms" onChange="display_register()" value="terms_accept">
                                <p>I accept the <a href="/r/legals?selectedTab=terms">Terms & Conditions & Privacy Policy</a> and <a href="/r/legals?selectedTab=social">social policy & as required by Pokerace Pty Ltd</a></p>
                            </div>
                        </div>
                        <div class="fields-holder col-6 hide" id="register_form">
                            <a href="#" class="btn btn-fb" style="display: none !important;"><span></span>Register with facebook</a>
                            <input type="text" name="fname" id="fname" placeholder="First Name" />
                            <input type="text" name="lname" id="lname" placeholder="Last Name" />
                            <input type="text" name="nname" id="nname" placeholder="Screen Name" />
                            <input type="email" name="email_register" id="email_register" placeholder="Email address" />
                            <select name="gender" id="gender" class="custom-select" data-placeholder-option="true">
                            ...
                            <!-- 
                            <select name="country-rewrite" id="country-rewrite" class="custom-select" data-placeholder-option="true" style="display: none;">
                            ...
                            <select name="birthYear" id="birthYear" class="custom-select" data-placeholder-option="true">
                                <option value="-1">Year of Birth</option>
                            </select>
                            <script>
	                            var birthYear = -1;
                            ...
                            <input type="submit" value="Register" id="register" onclick="register();" class="btn btn-green submit-btn" />
                        </div>
                    </div>
                </div>
            </main>
		...
		<script>
			$(document).ready(function() {
				...
				$("#message").css("max-width", "400px");
				$(".checkbox-holder-title").append($("#message"));
			});
		</script>
